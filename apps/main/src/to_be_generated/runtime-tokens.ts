...
export const REPLY_DVO = main.token<ReplyDvo>({
    class: ReplyDvo,
    interface: 'ReplyDvo',
    token: 'REPLY_DVO'
})
...
export const REPLY_RATING_DVO = main.token<ReplyRatingDvo>({
...
export const SITUATION_THREAD_DVO = main.token<SituationThreadDvo>({
