 ...
 */
export interface QUserTopicFavorite<IQE extends QUserTopicFavorite = any> extends QAirEntity<IQE | QUserTopicFavorite>
{
	// Id Fields
...
export interface QUserTopicFavoriteQRelation
	extends QAirEntityQRelation<UserTopicFavorite, QUserTopicFavorite>, QUserTopicFavoriteQId {
}