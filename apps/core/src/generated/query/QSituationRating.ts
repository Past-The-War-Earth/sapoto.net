 ...
 */
export interface QSituationRating<IQE extends QSituationRating = any> extends QAirEntity<IQE | QSituationRating>
{
	// Id Fields
...
export interface QSituationRatingQRelation
	extends QAirEntityQRelation<SituationRating, QSituationRating>, QSituationRatingQId {
}